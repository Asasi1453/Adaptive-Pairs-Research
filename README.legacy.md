> LEGACY WRITE-UP: predates the September 2026 methodology review. Figures below are historical, not validated current results. See [the review](docs/RESEARCH_AUDIT.md).
